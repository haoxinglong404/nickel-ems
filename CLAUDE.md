...
- `lubepoints` · 润滑点（**886** 个 · id = `lp_XXXX` / `lp_v6_001` / … / `lp_v13_NNN`(拆上下轴承) / `lp_v14_NNN`(污水泵结构统一) / `lp_v15_NNN`(浓密机减速机拆8点) / `lp_v16_NNN`(电机拆前/后轴承) / `lp_v17_NNN`(201B给料槽搅拌补齐轴承) / `lp_v18_001~012`(高压釜给料泵ABB电机前/后轴承·2026-07-16) / `lp_v19_001~002`(液下渣浆泵拆下轴承·2026-07-16) / `lp_v20_001~006`(褐铁矿浓密机主电机前/后轴承·2026-07-16)；2026-07-16 删 PAC/PAM 搅拌器「机架轴承」5 点=现场核实无此结构）
- `lubehistory` · 润滑执行记录
...
- 📝 10 个润滑点待补充标准油号（218 悬挂起重机 电机+减速机 4 + 546 未装机雨水回用泵 6）—— 2026-07-16 已从 54 清到 10（补标 23 + 免维护移出 11 + 删无效 5 + 拆点补 2 + 反洗泵 3）
