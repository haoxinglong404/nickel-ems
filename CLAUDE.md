...
- `lubepoints` · 润滑点（**883** 个 · id = `lp_XXXX` / `lp_v6_001` / … / `lp_v13_NNN`(拆上下轴承) / `lp_v14_NNN`(污水泵结构统一) / `lp_v15_NNN`(浓密机减速机拆8点) / `lp_v16_NNN`(电机拆前/后轴承) / `lp_v17_NNN`(201B给料槽搅拌补齐轴承) / `lp_v18_001~012`(高压釜给料泵ABB电机前/后轴承·2026-07-16)）
- `lubehistory` · 润滑执行记录
...
**最近做的改动**（按时间倒序）：
1. **PAC/PAM 搅拌器减速机点补油号**（2026-07-16，用户定标；**待 push**）：原属 54 待补油号且错标 oil，归位 grease。PAC 2 台 `lp_v8_025/028` = 2#锂基脂（MOBILUX EP 2）/**300g**/60天/1440h；PAM 3 台 `lp_v8_016/019/022` = 同油/**200g**/60天/1440h（国茂 BLD1/BLD0 摆线针轮小机座脂润滑；用户先说 PAC 后确认第二条是 PAM）。云端+SEED 同步。**同日再补絮凝剂搅拌器 12 台机架轴承**（lp_v8_063~096 隔3）= 2#锂基脂/30g/**80天/2000h**（用户确认按 2000 运行小时口径）。**再补罗茨风机 2 台轴承室**（lp_v8_098/100，诸城战尔说明书 P9§7 + 用户定油量）= VG220（MOBILGEAR EP 220）/20L/90天/2160h，原错标 grease 归位 oil；说明书另有「皮带端/驱动端黄油杯轴承 360h 补 2#脂」的要求，**现场若确有黄油杯部位需另建点（待用户核实）**。**再补回用水泵 4 台轴承室**（lp_v8_040/042/044/046）= 3#锂基脂（MOBILUX EP 3）/50g/30天/720h。待补 54→**31**（脂 572/油 280）。PAC/PAM 每台还剩「机架轴承」待补。
